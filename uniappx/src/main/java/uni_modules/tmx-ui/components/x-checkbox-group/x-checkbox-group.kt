...
open class GenUniModulesTmxUiComponentsXCheckboxGroupXCheckboxGroup : VueComponent {
    ...
    override fun data(): Map<String, Any?> {
        return utsMapOf("oldvalueList" to utsArrayOf<XCHECKBOX_LISTITEM_TYPE>(), "checkvaluelist" to utsArrayOf<String>(), "tid" to 0, "isDestroy" to false, "oldvalueList_ids" to computed<UTSArray<String>>(fun(): UTSArray<String> {
    ...
    override fun `$initMethods`() {
        this.addItem = fun(t: GenUniModulesTmxUiComponentsXCheckboxXCheckboxComponentPublicInstance, item: CHECKBOX_ITEM_INFO, ischange: Boolean) {
            var _this = this;
    ...
    open lateinit var addItem: (t: GenUniModulesTmxUiComponentsXCheckboxXCheckboxComponentPublicInstance, item: CHECKBOX_ITEM_INFO, ischange: Boolean) -> Unit;
    open lateinit var setOldCheckboxValue: () -> Unit;
    open lateinit var getcheckvaluelist: () -> Unit;
    open lateinit var pushAllChildren: () -> Unit;
    companion object {
        var name = "x-checkbox-group";
