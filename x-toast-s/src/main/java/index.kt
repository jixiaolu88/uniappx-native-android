...
val defaultConfig = XTOAST_TYPE_PRIVATE(iconColor = "rgb(5,121,255)", contentBgColor = "rgba(255,255,255,1)", maskBgColor = "rgba(0,0,0,0.6)", iconSize = 52, iconCode = "F449", title = "", titleSize = 14, titleColor = "rgb(5,121,255)", duration = 2500, size = 130, close = fun(){});
...
fun configCover(opts: XTOAST_TYPE): XTOAST_TYPE_PRIVATE {
    ...
    ;
    return XTOAST_TYPE_PRIVATE(iconColor = iconColor, contentBgColor = contentBgColor, maskBgColor = maskBgColor, iconSize = iconSize, iconCode = iconCode, title = title, titleSize = titleSize, titleColor = titleColor, duration = duration, close = close, size = size);
}
var tid: Number? = 0;
